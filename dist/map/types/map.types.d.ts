 ...
 */
export type FontFamily = 'MedievalSharp' | 'Pirata One' | 'Uncial Antiqua' | 'Cinzel' | 'IM Fell English';
/**
...
export declare const DEFAULT_SCALE_METADATA: ScaleMetadata;
export declare const FONT_OPTIONS: FontFamily[];
export declare const ROTATION_OPTIONS: RotationAngle[];
/**
